...
do
    Rscript $initname
    ./main initialize parallel single_w single_z full latent no_gamma true false no_ars nonzero_theta zero_beta lambda_free $v 10000 10000 10
done
