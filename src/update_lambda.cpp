...
void update_lambda(double &lambda, double &acc_lambda, const double &a_lambda,
  ...
  logr_lambda += stan::math::gamma_lpdf(lambda_s, a_lambda, b_lambda) -
                 ...
                 stan::math::lognormal_lpdf(lambda, stan::math::log(lambda_s), jump_lambda) -
                 stan::math::lognormal_lpdf(lambda_s, stan::math::log(lambda), jump_lambda);
  ...
  // accept or reject?
  if ((logr_lambda > 0.0) ||
      (logr_lambda > stan::math::log(stan::math::uniform_rng(0.0, 1.0, rng)))) {
    lambda = lambda_s;
    acc_lambda += 1.0;
  }
}
